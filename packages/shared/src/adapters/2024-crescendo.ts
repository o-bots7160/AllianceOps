...
const dutyTemplates: DutyTemplate[] = [
  {
    ...
    assignments: {
      AUTO_ROLE_1: { hint: 'Most reliable auto scorer — proven consistent path', strategy: 'strongest' },
      AUTO_ROLE_2: { hint: 'Second most reliable — stick to tested auto routine', strategy: 'strongest' },
      AUTO_ROLE_3: { hint: 'Simple mobility auto only — stay out of alliance paths', strategy: 'skip' },
      SPEAKER_SCORER: { hint: 'Best speaker accuracy — prioritize uncontested shots', strategy: 'strongest', epaRankKeysOverride: ['speaker_notes'] },
      AMP_SCORER: { hint: 'Steady amp scoring — do not force amplify windows', strategy: 'strongest', epaRankKeysOverride: ['amp_notes'] },
      CLIMBER_1: { hint: 'Most reliable climber — only attempt if >80% success rate', strategy: 'strongest' },
      ...
      FOUL_DISCIPLINE: { hint: 'All robots — wide berth on stage zone and protected areas', strategy: 'all' },
    },
  },
  {
    name: 'balanced',
    ...
    assignments: {
      ...
      SPEAKER_SCORER: { hint: 'Best speaker scorer — coordinate with amp for amplify windows', strategy: 'strongest', epaRankKeysOverride: ['speaker_notes', 'amplified_notes'] },
      AMP_SCORER: { hint: 'Best amp scorer — trigger amplify for speaker partner', strategy: 'strongest', epaRankKeysOverride: ['amp_notes'] },
      CLIMBER_1: { hint: 'Best climber — attempt stage climb', strategy: 'strongest' },
      CLIMBER_2: { hint: 'Second best climber or park if unreliable', strategy: 'strongest' },
      DEFENSE_ROLE: { hint: 'Weakest scorer plays light defense when opponent is cycling', strategy: 'weakest' },
      FOUL_DISCIPLINE: { hint: 'Defender stays clear of stage and source zones', strategy: 'all' },
    },
  },
  {
    name: 'aggressive',
    ...
    assignments: {
      ...
      AUTO_ROLE_3: { hint: 'Aggressive centerline positioning — deny opponent notes', strategy: 'strongest' },
      SPEAKER_SCORER: { hint: 'Fastest speaker cycles — shoot during every amplify window', strategy: 'strongest', epaRankKeysOverride: ['amplified_notes', 'speaker_notes'] },
      AMP_SCORER: { hint: 'Aggressive amp + force amplify every cycle', strategy: 'strongest', epaRankKeysOverride: ['amp_notes'] },
      CLIMBER_1: { hint: 'Stage climb + attempt trap note for bonus RP', strategy: 'strongest', epaRankKeysOverride: ['endgame_on_stage_points', 'endgame_trap_points'] },
      CLIMBER_2: { hint: 'Stage climb + harmony — coordinate timing with Climber 1', strategy: 'strongest', epaRankKeysOverride: ['endgame_on_stage_points', 'endgame_harmony_points'] },
      DEFENSE_ROLE: { hint: 'Dedicated defender — disrupt opponent speaker cycles and source access', strategy: 'weakest' },

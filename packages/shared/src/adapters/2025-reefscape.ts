...
const gameSpecificMetrics: GameMetricDefinition[] = [
  ...
  { key: 'algae_net', label: 'Algae Net', description: 'Algae scored in net', renderLocation: 'team_card', higherIsBetter: true },
  { key: 'algae_processor', label: 'Algae Processor', description: 'Algae scored in processor', renderLocation: 'team_card', higherIsBetter: true },
  { key: 'barge_points', label: 'Barge Points', description: 'Points from barge', renderLocation: 'briefing', higherIsBetter: true },
  { key: 'cage_points', label: 'Cage Points', description: 'Points from cage climb', renderLocation: 'briefing', higherIsBetter: true },
  ...
  mapScoreBreakdown(raw: TBAScoreBreakdown): GenericBreakdown {
    ...
    return {
      ...
      gameSpecific: {
        ...
        algae_net: num(raw['teleopAlgaeNet']),
        algae_processor: num(raw['teleopAlgaeProcessor']),

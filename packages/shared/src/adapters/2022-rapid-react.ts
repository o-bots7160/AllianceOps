...
const dutySlots: DutySlotDefinition[] = [
  ...
  {
    key: 'UPPER_HUB_SCORER',
    label: 'Upper Hub Scorer',
    description: 'Primary upper hub cargo scorer',
    category: 'teleop',
    epaRankKeys: ['teleop_cargo_upper'],
  },
  {
    key: 'LOWER_HUB_SCORER',
    label: 'Lower Hub Scorer',
    description: 'Lower hub cargo scorer',
    category: 'teleop',
    epaRankKeys: ['teleop_cargo_lower'],
  },
  {
    key: 'HANGAR_CLIMBER_1',
    label: 'Hangar Climber 1',
    description: 'Primary hangar climber',
    category: 'endgame',
    epaRankKeys: ['endgame_points'],
  },
  {
    key: 'HANGAR_CLIMBER_2',
    label: 'Hangar Climber 2',
    description: 'Secondary hangar climber',
    category: 'endgame',
    epaRankKeys: ['endgame_points'],
  },
  {
...
const dutyTemplates: DutyTemplate[] = [
  {
    ...
    assignments: {
      AUTO_ROLE_1: {
        hint: 'Most reliable auto — taxi + consistent cargo placement',
        strategy: 'strongest',
      },
      ...
      UPPER_HUB_SCORER: {
        hint: 'Best cargo scorer — focus on upper hub for points',
        strategy: 'strongest',
        epaRankKeysOverride: ['teleop_cargo_upper'],
      },
      LOWER_HUB_SCORER: {
        hint: 'Steady lower hub scoring — reliable and fast cycles',
        strategy: 'strongest',
        epaRankKeysOverride: ['teleop_cargo_lower'],
      },
      HANGAR_CLIMBER_1: {
        hint: 'Most reliable hangar climb — attempt Mid or High if consistent',
        strategy: 'strongest',
      },
      HANGAR_CLIMBER_2: {
        hint: 'Low rung or skip — no parking points in Rapid React',
        strategy: 'skip',
      },
      DEFENSE_ROLE: { hint: 'No defense — all robots focus on cargo scoring', strategy: 'skip' },
      FOUL_DISCIPLINE: {
        hint: 'All robots — stay clear of opponent loading zones and launchpad; do not score opponent-color cargo (awards pts to them)',
        strategy: 'all',
      },
    },
  },
  {
    ...
    assignments: {
      ...
      UPPER_HUB_SCORER: {
        hint: 'Best cargo scorer — prioritize upper hub cycles',
        strategy: 'strongest',
        epaRankKeysOverride: ['teleop_cargo_upper'],
      },
      LOWER_HUB_SCORER: {
        hint: 'Support scorer — mix of upper/lower based on traffic',
        strategy: 'strongest',
      },
      HANGAR_CLIMBER_1: {
        hint: 'Best climber — attempt High or Traversal rung',
        strategy: 'strongest',
      },
      HANGAR_CLIMBER_2: {
        hint: 'Second climber — Mid or Low rung (Hangar RP needs 16+ endgame pts)',
        strategy: 'strongest',
      },
      DEFENSE_ROLE: {
        hint: 'Weakest scorer plays light defense — disrupt opponent cargo cycles',
        strategy: 'weakest',
      },
      FOUL_DISCIPLINE: {
        hint: 'Defender stays clear of launchpad and terminal; do not score opponent-color cargo',
        strategy: 'all',
      },
    },
  },
  {
    ...
    assignments: {
      AUTO_ROLE_1: {
        hint: 'Best auto — taxi + 2 cargo scored for Cargo RP setup',
        strategy: 'strongest',
      },
      AUTO_ROLE_2: { hint: 'Second best auto — taxi + 1 cargo shot', strategy: 'strongest' },
      AUTO_ROLE_3: {
        hint: 'Aggressive — contest terminal cargo, maximize auto count toward Cargo RP',
        strategy: 'strongest',
      },
      UPPER_HUB_SCORER: {
        hint: 'Fastest upper hub cycles — push for Cargo RP threshold (20 cargo total)',
        strategy: 'strongest',
        epaRankKeysOverride: ['teleop_cargo_upper'],
      },
      LOWER_HUB_SCORER: {
        hint: 'Aggressive upper scoring as well — maximize match cargo total',
        strategy: 'strongest',
        epaRankKeysOverride: ['teleop_cargo_upper', 'teleop_cargo_lower'],
      },
      HANGAR_CLIMBER_1: {
        hint: 'Traversal rung (10 pts) — Hangar RP needs 16+ pts alliance-wide',
        strategy: 'strongest',
        epaRankKeysOverride: ['endgame_points'],
      },
      HANGAR_CLIMBER_2: {
        hint: 'Traversal or High rung — with 2nd robot at Mid+ (6 pts), alliance reaches Hangar RP',
        strategy: 'strongest',
        epaRankKeysOverride: ['endgame_points'],
      },
      DEFENSE_ROLE: {
        hint: 'Dedicated defender — disrupt opponent cargo cycles and terminal access',
        strategy: 'weakest',
      },
      FOUL_DISCIPLINE: {
        hint: 'Avoid opponent cargo lanes — do not contact robots in their launchpad (FOUL); do not score wrong-color cargo',
        strategy: 'all',
      },
    },
  },
...
const gameSpecificMetrics: GameMetricDefinition[] = [
  {
    key: 'auto_cargo',
    label: 'Auto Cargo',
    description: 'Cargo scored in autonomous',
    renderLocation: 'team_card',
    higherIsBetter: true,
  },
  {
    key: 'teleop_cargo_upper',
    label: 'Upper Hub',
    description: 'Cargo scored in upper hub',
    renderLocation: 'team_card',
    higherIsBetter: true,
  },
  {
    key: 'teleop_cargo_lower',
    label: 'Lower Hub',
    description: 'Cargo scored in lower hub',
    renderLocation: 'team_card',
    higherIsBetter: true,
  },
  {
    key: 'teleop_cargo_total',
    label: 'Teleop Cargo',
    description: 'Total cargo scored in teleop',
    renderLocation: 'team_card',
    higherIsBetter: true,
  },
  {
    key: 'match_cargo_total',
    label: 'Total Cargo',
    description: 'Total cargo scored all periods',
    renderLocation: 'team_card',
    higherIsBetter: true,
  },
  {

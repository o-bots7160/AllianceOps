...
| Azure Functions               | Flex Consumption (FC1) | ~$0 (pay-per-execution, scales to zero) |
...
| ----------------------------- | ------------------------------------------------ | ---------------------- |
| Azure Static Web Apps         | Standard                                         | $9/month               |
| Azure Functions               | Flex Consumption (FC1) + 1 always-ready instance | ~$5-8/month            |
| Azure Database for PostgreSQL | Burstable B2s                                    | ~$26/month             |
| Azure Key Vault               | Standard                                         | ~$0.03/10K operations  |
| Application Insights          | Pay-as-you-go                                    | ~$0 (5 GB free/month)  |
| Log Analytics Workspace       | PerGB2018                                        | ~$0 (5 GB free/month)  |
| Storage Account (Functions)   | Standard LRS                                     | ~$0.02/month           |

**Estimated prod total: ~$40-43/month**
...
4. **Flex Consumption (both envs)** — Both dev and prod use FC1. Dev scales to zero when not in use. Prod has 1 always-ready instance to eliminate cold starts (~$5-8/month)
